...
const userLetterChoice = document.getElementById("user-letter-choice")
...
// const userLetterInput = (e) => {
//   let letter = e.target.value
//   console.log(letter) // assign this value to guess in runGameFunction()
//   // return letter
// }
// userLetterChoice.addEventListener("input", userLetterInput);
console.log(userLetterChoice.value)

const runGameFeature = (word) => {
  let guess = ''

  do {
    guess = userLetterChoice.value
...
const confirmGameOver = () => {
  if(incorrectGuesses === 6 || dashArr.indexOf("_") === -1) {
    isGameOver = true
  } 
}
